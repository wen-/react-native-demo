...
class TabBarBottom extends React.PureComponent {
    ...
    _renderLabel = scene => {
        ...
        if(scene.route.routes[0]&&scene.route.routes[0].params&&scene.route.routes[0].params.showLabel === false){
            return null;
        }
        const { index } = scene;
    ...
    render() {
        ...
        return (
            <Animated.View style={animateStyle}>
                <ViewOverflow style={tabBarStyle}>
                    {routes.map((route, index) => {
                        ...
                        return (
                            ...
                            >
                                <ViewOverflow style={[styles.tab, { backgroundColor:focused?activeBackgroundColor:inactiveBackgroundColor }]}>
                                    <View
                                        style={[
                                            styles.tab,
